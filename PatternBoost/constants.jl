...
const NUM_INITIAL_EMPTY_OBJECTS = 50#_000 #on the first run, this many rollouts will be done from empty graphs/objects
const FINAL_DATABASE_SIZE = 50#_000 # Size of learning set
const TARGET_DB_SIZE = 5#_000 # Database size will never be twice bigger than that
